...
Welcome to the introduction lecture for **Decision Analysis and Forecasting for Agricultural Development**. We are excited to deliver you this course content and to train a new generation of experts in applying these tools. We see enormous scope for application of these methods in agriculture and the need for more practitioners.  
...
- develop decision models and comprehensively evaluate the findings using the `R` programming language with functions from the `decisionSupport` package. 
...
-	Write a ~ 5,000 word paper in RMarkdown, see this report on [plotting high-dimensional data](github.com/hortibonn/Plotting-High-Dimensional-Data) for a useful example of how this can be done

### Further reading

Anderson, Jock, John Dillon, and Brian Hardaker. 1978. Agricultural Decision Analysis. Ames, Iowa: Iowa State University Press.

Howard, Ronald A., and Ali E. Abbas. 2015. Foundations of Decision Analysis. NY, NY: Prentice Hall.

# Invited Lecture 1: (on Ag. Dev. Project [speaker TBA])
