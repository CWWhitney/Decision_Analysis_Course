...
# ![decisionSupport](figures/decisionSupport_hex_sticker.png){width=40%} {-#header}
...
-	*So What?* The aim is for you to become a critical thinker and generating useful forecasts for decision makers in agricultural development.
...
- develop decision models and comprehensively evaluate the findings using `R` and `decisionSupport` functions. 
...
Class participation will be about 50% of the work in this course.	We will expect you to show up in class and may have short weekly tests for seeing how up to speed you are. We will track your project activity (follow your git repositories etc.). 
...
-	~ 5,000 word paper written in RMarkdown, see this report on [plotting high-dimensional data](github.com/hortibonn/Plotting-High-Dimensional-Data) for example
