...
```{r models-seminar-burkina-model}
...
In our seminar meeting each group will present the decision and proposed model that they will be programming for the rest of the course. See the first part of the talk by Hoa Do in the [Lecture 8 on forecasts](#forecasts) for an example of how to present a model overview in succinct and clear way. The model is presented in the first three minutes of [the talk](https://youtu.be/MlIetFhu87U). 
