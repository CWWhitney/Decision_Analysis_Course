...
Generate the Variable Importance in the Projection (VIP) scores of the PLS for the input variables based on the apple sheep model. Check `names(df)` to see the list of variables and run `evpi` on the NPVs (the last few in the table, starting with `"NPV_Agroforestry_System"`). 
...
plot_evpi(EVPIresults = EVPI, decision_vars = "NPV_Agroforestry_System")
