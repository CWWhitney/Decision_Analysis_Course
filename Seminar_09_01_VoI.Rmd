...
We can save our input estimates as a csv 

```{r assign_results_voi}
...
Generate the VIP scores for the input variables based on the AF model.

```{r apple_sheep_evpi_test}

#extract only the NPV columns (the last few in the table, starting with "NPV_decision")
