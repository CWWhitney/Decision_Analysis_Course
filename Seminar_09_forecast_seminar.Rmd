...
# calculate the overall NPV of the decison (do - don't do)
...
Calculate Value of Information (VoI) analysis with the Expected Value of Perfect Information (EVPI). As we learned in [Lecture 8 on forecasts](#forecasts), EVPI is determined by examining the influence of a given variable on the output value of a decision model. 
...
mcSimulation_table <- data.frame(hail_mc_simulation$x, 
