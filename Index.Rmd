...
library(bayesplot)
# library(devtools)
# install.packages(c("bayesplot", "decisionSupport", "DiagrammeR", "ggcorrplot", "ggplot2", "ggrepel", "ggridges", "ggthemes", "igraph", "knitr", "learnr", "pander", "plyr", "rmarkdown", "tidyverse"))
...
```{r child="Practical_Schiffers.Rmd"}
```
