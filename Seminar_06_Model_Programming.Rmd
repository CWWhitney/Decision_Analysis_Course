...
Applying `make_variables` to the data table (with default setting `n=1`) generates one random number for each variable, which then allows you to easily test code you are developing. Try running this function on your code as you build the decision function. 
