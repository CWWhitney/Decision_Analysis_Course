...
### Decision analysis case - Calluna production in NRW
...
question("How can you consider the fact that experts tend to make mistakes when estimating and judging?",
answer("Confront the participants from your expert network with their biases", correct = TRUE),
answer("Teach techniques that allow your participants to do better estimations (Calibration training)", correct = TRUE),
...
### Case study - Using plastic covers in sweet cherry orchards in Chile

This video shows the study we conducted in Chile for assessing the profitability of implementing plastic covers in sweet cherry orchards to protect the fruits from hazardous weather events.
